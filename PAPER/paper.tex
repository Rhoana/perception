...
% - 
\title{Reproducing 'Graphical Perception' with CNNs}
...
\shortauthortitle{Haehn \MakeLowercase{\textit{et al.}}: Computing Graphical Perception with Convolutional Neural Networks}
