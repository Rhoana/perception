...
#
#
print 'Running', EXPERIMENT, 'on dataset', DATASET, 'with', CLASSIFIER, 'Noise:', NOISE, 'Job Index', JOB_INDEX, 'Factor', FACTOR
...
if NOISE == 'True':
  NOISE = True
  SUFFIX = '_' + str(FACTOR) + '_noise.'
else:
  NOISE = False



if EXPERIMENT == 'C.Figure1.multi':
  ...
  def DATATYPE(data):
    ...
    choices = ['position_common_scale', 'position_non_aligned_scale', 'area', 'curvature', \
              'length', 'shading', 'volume', 'direction', 'angle']

    choice = np.random.choice(choices)
    
    return eval('C.Figure1.'+choice)(data)
...
#
#
train_target = 60000*FACTOR
val_target = 20000*FACTOR
test_target = 20000*FACTOR
